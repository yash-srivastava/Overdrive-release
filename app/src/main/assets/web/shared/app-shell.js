...
(function () {
    ...
    function buildEvCard() {
        ...
        var s = '<div class="status-card ev-card" id="evCard">'
            ...
            +   '</div>'
            +   '<div class="ev-completion-row" id="evCompletionRow" style="display:none;">'
            ...
            +     '<div class="ev-completion-copy">'
            +       '<span class="ev-completion-primary" id="evCompletionPrimary"></span>'
            +       '<span class="ev-completion-secondary" id="evCompletionSecondary"></span>'
            +     '</div>'
            +   '</div>'
